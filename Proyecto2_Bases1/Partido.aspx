<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Partido.aspx.cs" Inherits="Proyecto2_Bases1.Partido" %>
...
<body class="is-preload">
    ...
    <section id="main" class="container">
        ...
        <section class="box">
            ...
            <h3>Datos</h3>
            <p>Sede: <%= this.PSede %></p>
            <p>Fecha: <%= this.PFecha %></p>
            <p>Hora: <%= this.Phora %></p>
            <p>Torneo: <%= this.Ptorneo %></p>
            <p>A. Cental: <%= this.Pcental %></p>
            <p>1er. Asistente: <%= this.Pasis1 %></p>
            <p>2do. Asistente: <%= this.Pasis2 %></p>
